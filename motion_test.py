...
def 고양이2():
    for _ in range(4):
        joint_move_to([176.66, 190.72, 182.9, 190.28, 203.91, 159.96])
        # joint_move_to([176.83, 162.77, 214.89, 189.05, 203.2, 159.96])
        joint_move_to([179.47, 145.99, 249.17, 185.71, 175.96, 159.96])
        # joint_move_to([176.83, 162.77, 214.89, 189.05, 203.2, 159.96])
        joint_move_to([176.66, 190.72, 182.9, 190.28, 203.91, 159.96])
